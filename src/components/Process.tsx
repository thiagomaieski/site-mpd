      ...
      <div className="max-w-[1280px] mx-auto px-6 xl:px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-px lg:bg-[#EDEDED]">
          {STEPS.map((step, i) => (
            ...
            >
              ...
              <h3 className="font-serif font-semibold text-[#1A1A1A] text-xl lg:text-2xl leading-snug mb-3">
                {step.title}
              </h3>
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center gap-5 justify-between bg-[#1A1A1A] p-7 lg:px-10 border border-[#C59C47]/10">
          ...
          <a
            ...
            className="flex-shrink-0 inline-flex items-center gap-3 bg-transparent border border-[#C59C47] text-[#C59C47] hover:bg-[#C59C47] hover:text-white px-7 py-3 text-xs sm:text-sm font-sans font-bold uppercase tracking-[0.16em] transition-all duration-300 whitespace-nowrap"
          >
